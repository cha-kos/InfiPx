...
l6 = Like.create({user_id: u4.id, photo_id: p2.id})
l6 = Like.create({user_id: u4.id, photo_id: p3.id})
l6 = Like.create({user_id: u4.id, photo_id: p4.id})
l6 = Like.create({user_id: u4.id, photo_id: p5.id})
l6 = Like.create({user_id: u4.id, photo_id: p6.id})
l6 = Like.create({user_id: u4.id, photo_id: p7.id})
l6 = Like.create({user_id: u4.id, photo_id: p8.id})
l6 = Like.create({user_id: u4.id, photo_id: p9.id})
Like.create({user_id: u5.id, photo_id: p10.id})
Like.create({user_id: u5.id, photo_id: p11.id})
Like.create({user_id: u5.id, photo_id: p24.id})
Like.create({user_id: u5.id, photo_id: p22.id})
Like.create({user_id: u5.id, photo_id: p10.id})
Like.create({user_id: u5.id, photo_id: p10.id})
Like.create({user_id: u5.id, photo_id: p10.id})
Like.create({user_id: u5.id, photo_id: p10.id})
